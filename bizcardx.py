...
# creating page
icon = Image.open("C:\\Users\\91832\\Downloads\\icon.png")#use your path here
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Guna",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Guna*!"""})
st.markdown("<h1 style='text-align: center; color:#FFDAB9;'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)

# settting background image
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://wallpapers.com/images/hd/world-map-in-plain-blue-bgi1o5hls0nblaxy.webp");
                        background-size: cover}}
                     </style>""",unsafe_allow_html=True) 
setting_bg()

# we will have menu to choose
...
if selected == "Home":
    ...
    with col1:
        st.markdown('<span style="color:#FFDAB9; font-size:20px;">**Technologies Used:**</span> Python, easy OCR, Streamlit, SQL, Pandas', unsafe_allow_html=True)
        st.markdown('<span style="color:#FFDAB9; font-size:20px;">**Overview:**</span> In this Streamlit web app you can upload an image of a business card and extract relevant information from it using easyOCR. You can view, modify, or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.', unsafe_allow_html=True)
    with col2:
        st.image("C:\\Users\\91832\\Desktop\\Creative Modern Business Card\\bizcard.jpg")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        # Displaying thr card with highlights
        with col2:
            st.markdown("#     ")
            st.markdown("#     ")
        ...
        # Converting image to binary to load into database
